...
sys.path.insert(0, str(current_dir.parent / "DINO_Frame_Selection"))
...
def test_dino_visualization():
    ...
    # Paths - use current directory structure
    current_dir = Path(__file__).parent
    background_frames_dir = current_dir / "background_frames"
    output_dir = current_dir / "dino_visualization_results"
