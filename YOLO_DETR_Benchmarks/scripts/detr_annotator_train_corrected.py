...
def train(args):
    ...
    if args.resume_training:
        ...
        if latest_checkpoint_path:
            ...
            model.module, optimizer, start_epoch = load_checkpoint(
                latest_checkpoint_path, model.module, optimizer, device
            )
            ...
            if val_dataloader:
                ...
                with torch.no_grad():
                    for i_val, batch_val in enumerate(progress_bar_val):
                        ...
                        # Move batch to device (same as training)
                        batch_on_device_val = {}
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train DETR with DDP")
